...
- This AlgoKit project is the canonical home for MYGLOBAL on-chain code (PuyaTs/PuyaPy contracts + generated clients).
- Other MYGLOBAL repos should consume the generated clients/app specs from here rather than duplicating ABI definitions.
